      ...
      >
        {phase === "input" && (
          <View>
            ...
            <TouchableOpacity
              style={[
                styles.btn,
                (!rawText.trim() || loading) && styles.btnDisabled,
              ]}
        ...
        {phase === "review" && suggestion && (
          <View>
            ...
            <Text style={styles.subheading}>
              AI interpretation — accept or reject below.
            </Text>
            ...
            <SuggestionField
              ...
              value={suggestion.suggestion.commitment_type}
            />
            <SuggestionField
              label="Urgency"
              value={String(suggestion.suggestion.urgency)}
            />
            {suggestion.suggestion.deadline_hint && (
              <SuggestionField
                label="Deadline hint"
                value={suggestion.suggestion.deadline_hint}
              />
            )}
